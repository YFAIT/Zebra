...
namespace SurfaceTrails2.FlockingInMesh
{
    public class FlockAgent
    {
        ...
        public void ComputeDesiredVelocity(List<FlockAgent> neighbours)
        {
            ...
            //double boundingBoxMinX = FlockSystem.BBox.PointAt(0, 0, 0).X;
            //double boundingBoxMinY = FlockSystem.BBox.PointAt(0, 0, 0).Y;
            //double boundingBoxMinZ = FlockSystem.BBox.PointAt(0, 0, 0).Z;
            //double boundingBoxMaxX = FlockSystem.BBox.PointAt(1, 1, 1).X;
            //double boundingBoxMaxY = FlockSystem.BBox.PointAt(1, 1, 1).Y;
            //double boundingBoxMaxZ = FlockSystem.BBox.PointAt(1, 1, 1).Z;
