...
// ===============================================================================================
    ...
    public class Repeller : IAgentBehaviours
    {
        ...
        BehaviourType IAgentBehaviours.BehaviourType
        {
            get { return BehaviourType = BehaviourType.Repeller; }
    ...
    public class Attractor : IAgentBehaviours
    {
        ...
        BehaviourType IAgentBehaviours.BehaviourType
        {
            get { return BehaviourType = BehaviourType.Attractor; }
            set { BehaviourType = value; }
        }
        public Point3d Position { get; set; }
        public Vector3d DesiredVelocity { get; set; }
    ...
    public class AttractorCurve : IAgentBehaviours
    {
        ...
        BehaviourType IAgentBehaviours.BehaviourType
        {
            get { return BehaviourType = BehaviourType.AttractorCurve; }
            set { BehaviourType = value; }
        }
    ...
    public class RepellerCurve : IAgentBehaviours
    {
        public BehaviourType BehaviourType { get; set; }
        BehaviourType IAgentBehaviours.BehaviourType
        {
            get { return BehaviourType = BehaviourType.RepellerCurve; }
            set { BehaviourType = value; }
        }
        public List<Curve> Curves { get; set; }
        public Point3d Position { get; set; }
        ...
        public Vector3d ComputeDesiredVelocity()
        {
            double distanceToRepeller = Position.DistanceTo(ClosestPoint);
            Vector3d repulsion = Position - ClosestPoint ;
            // Attraction gets stronger as the agent gets closer to the attractor
            repulsion /= (repulsion.Length * distanceToRepeller);
    ...
    public class Wind : IAgentBehaviours
    {
        ...
        BehaviourType IAgentBehaviours.BehaviourType
        {
            get { return BehaviourType = BehaviourType.Wind; }
            set { BehaviourType = value; }
        }
        public Point3d Position { get; set; }
    ...
    public class FollowOrganizedPoints : IAgentBehaviours
    {
        ...
        BehaviourType IAgentBehaviours.BehaviourType
        {
            get { return BehaviourType = BehaviourType.FollowPoints; }
            set { BehaviourType = value; }
        }
        public List<Circle> Circles { get; set; }
        public Point3d Position { get; set; }
    ...
    public class FollowCurve : IAgentBehaviours
    {
        ...
        BehaviourType IAgentBehaviours.BehaviourType
        {
            get { return BehaviourType = BehaviourType.FollowCurve; }
            set { BehaviourType = value; }
        }
        public List<Circle> Circles { get; set; }
        public Point3d Position { get; set; }
