...
//            var Agents = new List<FlockAgent.FlockAgent>();
//            Curve curve = null;
...
//            {
//                var randPt = PointOperations.GetRandomPoint(min.X, max.X, min.Y, max.Y, 0.0, 0.0);
//                //var randPt = new Point3d(randX,randY,0);


//                FlockAgent.FlockAgent agent = new FlockAgent.FlockAgent(randPt, VectorOperations.GetRandomUnitVectorXY() * 4.0);
...
//                agent.Containment.Add(planeContainment);
...
//            foreach (FlockAgent.FlockAgent agent in flockSystem.IAgents)
//            {
