...
namespace SurfaceTrails2.AgentBased
{
    ...
    {
        Vector3d Behaviour(List<IFlockAgent> neighbours, Point3d Position, Vector3d desiredVelocity,
            FlockSystem flockSystem);
    }

    class Alignment : IAgentBehaviour
    {
        public Vector3d Behaviour(List<IFlockAgent> neighbours, Point3d Position, Vector3d desiredVelocity,
            FlockSystem flockSystem)
        {
    ...
    class Cohesion : IAgentBehaviour
    {
        public Vector3d Behaviour(List<IFlockAgent> neighbours, Point3d Position, Vector3d desiredVelocity,
            FlockSystem flockSystem)
        {
    ...
    class Separation : IAgentBehaviour
    {
        public Vector3d Behaviour(List<IFlockAgent> neighbours, Point3d Position, Vector3d desiredVelocity,
            FlockSystem flockSystem)
        {
    ...
    class Repellers : IAgentBehaviour
    {
        public Vector3d Behaviour(List<IFlockAgent> neighbours, Point3d Position, Vector3d desiredVelocity,
            FlockSystem flockSystem)
        {
    ...
    class Attractors : IAgentBehaviour
    {
        public Vector3d Behaviour(List<IFlockAgent> neighbours, Point3d Position, Vector3d desiredVelocity,
            FlockSystem flockSystem)
        {
    ...
    class AttractorCurve : IAgentBehaviour
    {
    ...
    class Wind : IAgentBehaviour
    {
        public Vector3d Behaviour(List<IFlockAgent> neighbours, Point3d Position, Vector3d desiredVelocity,
            FlockSystem flockSystem)
        {
             var wind = flockSystem.Wind * 5;
            desiredVelocity += wind;
            return desiredVelocity;
        }
    }
